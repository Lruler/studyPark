...
export default function QuizA(props) {
    ...
    const radioTypeB = ['非常不', '比较不', '有点不', '中立', '有点', '比较', '非常']
    ...
    return (
        <div className='quiz-c'>
                                ...
                                return (
                                    <div className='quiz-q-i' key={quiz}>
                                        ...
                                        <div className="quiz-radios">
                                            {radios.map((radio) => {
                                                return (
                                                    <div key={quiz + radio} className={(index - 6) % 10 === 0 ? 'quiz-rt' : 'quiz-radio'}>
                                                        {(index - 6) % 10 === 0 ? <div className='quiz-type'><b>{radioType[radio - 1]}</b></div> : null}
            ...
            <div onClick={handleToA} className="tostudy">提交</div>
        </div>
    )
}
